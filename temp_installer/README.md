...
# Или полная пересборка с чистым окружением
.\rebuild_venv.ps1
```
...
### 🔄 Перенос компонентов в GUI (НОВОЕ!)
- **Ручной перенос в "Не распределено"** - новая секция в главном окне
- Просто вставьте названия неправильно классифицированных компонентов
- Программа найдет и переместит их для переклассификации
- Поддержка частичного поиска по названию (регистронезависимый)
- Автоматическая интеграция с интерактивной классификацией

### 🎯 Улучшенная классификация компонентов
- **Оптические компоненты** - корректное определение модулей с "photonic", "optical" в названии
- **СВЧ модули** - аттенюаторы, делители, ответвители от Qualwave, Mini-Circuits, A-INFO, Quantic PMI
- **Модули связи** - NT1, Ebyte и другие телекоммуникационные модули
- **Исправлена ложная классификация** - компоненты больше не попадают в "Микросхемы" из-за "ic" в названии производителя
