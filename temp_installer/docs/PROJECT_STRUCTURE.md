...
│
├── 📦 bom_categorizer/                   # Модульная структура (v2.0.15)
│   ├── __init__.py                       # Инициализация модуля (метаданные v2.0.15)
│   ├── main.py                           # CLI точка входа и оркестрация
│   ├── classifiers.py                    # Классификация компонентов (улучшенная классификация оптики, полупроводников)
│   ├── parsers.py                        # Парсеры TXT/DOCX/Excel (унифицированная обработка)
│   ├── formatters.py                     # Форматирование данных (извлечение ТУ перед агрегацией, нормализация тире)
│   ├── excel_writer.py                   # Запись Excel с форматированием (границы ячеек, улучшенная сортировка)
│   ├── txt_writer.py                     # Генерация TXT отчетов
│   ├── utils.py                          # Утилиты и regex
│   └── gui.py                            # Tkinter GUI (PIN защита, интерактивная классификация, вертикальная прокрутка)
│
...
|--------|------|-------------------|
| 2.0.15 | 27.10.2025 | **Текущая версия** - Поддержка групповых заголовков, категория "Не ИВП", нормализация DOCX |
...
## 📌 Основные возможности v2.0.15

### 🆕 Новые функции v2.0.15:
