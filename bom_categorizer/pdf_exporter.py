...
class PDFExporter:
    ...
    def _create_table(self, data: List[List], sheet: Worksheet, is_compact: bool = False, sheet_name: str = None) -> Table:
        ...
        if num_cols == 9:
            ...
            # Реальный порядок: №, Наименование ИВП, ТУ, Источник, шт., Примечание, № ТРУ, Стоимость, КОД ERP
            # Сумма: 8+48+38+42+10+40+24+20+25 = 255mm
            col_widths = [
                8*mm,    # 1. №
                48*mm,   # 2. Наименование ИВП
                38*mm,   # 3. ТУ/Производитель
                42*mm,   # 4. Источник
                10*mm,   # 5. шт.
                40*mm,   # 6. Примечание
                24*mm,   # 7. № ТРУ
