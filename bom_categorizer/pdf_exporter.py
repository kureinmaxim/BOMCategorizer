...
class PDFExporter:
    ...
    def _create_table(self, data: List[List], sheet: Worksheet, is_compact: bool = False, sheet_name: str = None) -> Table:
        ...
        # Предполагаем стандартную структуру BOM: № п/п, Наименование, ТУ, Источник, Кол-во, Примечание, № ТРУ, Стоимость
        if num_cols == 8:
