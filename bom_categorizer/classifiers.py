...
def classify_row(
    ...
    # ===================================================================
    # НАИВЫСШИЙ ПРИОРИТЕТ: Наши разработки (проверяем ПЕРВЫМИ!)
    # Любые компоненты с кодами АМФИ - это собственные разработки
    # ===================================================================
    ...
    if has_any(text_blob, ["дроссель", "inductor", "катушка индуктивности", "индуктивность", "сердечник", "core"]):
        return "inductors"
