...
3. [Как обновить версию](#как-обновить-версию)
4. [Синхронизация файлов сборки](#синхронизация-файлов-сборки)
5. [Автоматизация](#автоматизация)
6. [Файловая структура](#файловая-структура)
7. [Роль локальных config файлов](#роль-локальных-config-файлов)
...
# 2. Синхронизировать (версии могут отличаться)
python update_version.py sync
...
1. Проверьте статус: `python update_version.py status`
2. Синхронизируйте: `python update_version.py sync`
3. Посмотрите справку: `python update_version.py help`
