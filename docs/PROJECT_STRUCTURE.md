...
## 🗂️ Организация файлов (v3.3.0 / v4.3.0)

> 🎨 **НОВОЕ:** Проект поддерживает две независимые версии GUI:
> - **Standard v3.3.0** (Tkinter) - стабильная
> - **Modern Edition v4.3.0** (PySide6) - современная с AI-подсказками, Drag & Drop и CLI
...
|--------|------|-------------------|
| **3.3.0/4.3.0** | **12.11.2025** | **🎉 ТЕКУЩАЯ ВЕРСИЯ** - AI-подсказки для классификации! Интеграция с Claude/GPT/Ollama, модульный рефакторинг (11 модулей, ~5500 строк), глобальный поиск, поиск PDF, экспериментальная ветка с AI, Drag & Drop, CLI и PDF экспортом |
...
*Создано: 06.10.2025*  
*Обновлено: 12.11.2025 (централизованное управление версиями)*  
*Версия проекта: Standard 3.3.0 / Modern Edition 4.2.3*  
*Экспериментальная ветка: experimental/new-feature (AI, Drag & Drop, CLI, PDF Export)*  
*Новое: Система управления версиями (update_version.py, config шаблоны)*  
*Статус: ✅ Актуально*
