...
## 🗂️ Организация файлов (v3.3.0 / v4.3.7)

> 🎨 **НОВОЕ:** Проект поддерживает две независимые версии GUI:
> - **Standard v3.3.0** (Tkinter) - стабильная
> - **Modern Edition v4.3.7** (PySide6) - современная с AI-подсказками, Drag & Drop, CLI и кроссплатформенной конвертацией .doc
> - **Экспериментальная ветка** `experimental/new-feature` с расширенными функциями (AI, PDF, D&D, CLI)
...
│   │
│   ├── 🚀 ЭКСПЕРИМЕНТАЛЬНЫЕ (ветка experimental/new-feature):
...
│   └── ... (ещё 9+ пакетов)
│
├── 🚀 ЭКСПЕРИМЕНТАЛЬНЫЕ ДОКУМЕНТЫ (ветка experimental/new-feature):
...
├── 📄 EXPERIMENTAL_FEATURES.md           # Описание всех экспериментальных функций
...
|--------|------|-------------------|
| **3.3.0/4.3.7** | **15.11.2025** | **🎉 ТЕКУЩАЯ ВЕРСИЯ** - 🍎 Исправлены шрифты на macOS Retina! 🔄 Автоматическая конвертация .doc через LibreOffice (macOS/Linux)! AI-подсказки для классификации, интеграция с Claude/GPT/Ollama, модульный рефакторинг (11 модулей, ~5500 строк), глобальный поиск, поиск PDF, экспериментальная ветка с AI, Drag & Drop, CLI и PDF экспортом |
...
| 3.3.0/4.3.0 | 12.11.2025 | AI-подсказки для классификации! Интеграция с Claude/GPT/Ollama, модульный рефакторинг (11 модулей, ~5500 строк), глобальный поиск, поиск PDF, экспериментальная ветка с AI, Drag & Drop, CLI и PDF экспортом |
...
| 3.3.0/4.2.2 | 12.11.2025 | Модульный рефакторинг Modern Edition! 10 модулей (~5000 строк), глобальный поиск, поиск PDF, экспериментальная ветка с Drag & Drop, CLI и PDF экспортом. Горячие клавиши портированы в Standard v3.3.0 |
...
#### Modern Edition v4.3.7 (PySide6) ✨
- **Экспериментальная версия** - современный дизайн с AI
...
*Создано: 06.10.2025*  
*Обновлено: 15.11.2025 (macOS Retina support + LibreOffice integration)*  
...
*Новое: 🍎 Исправлены шрифты на macOS Retina, 🔄 Автоматическая конвертация .doc через LibreOffice*  
*Статус: ✅ Актуально*
