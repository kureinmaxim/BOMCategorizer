...
|--------|------|-------------------|
| **3.1.3** | **07.11.2025** | **🎉 ТЕКУЩАЯ ВЕРСИЯ** - Подготовка к GitHub! Пароль по умолчанию изменен на 1234, создан .gitignore, объединены changelog файлы, удалены тестовые файлы и личные данные. Проект готов к публикации |
