...
│
├── 📦 bom_categorizer/                   # Модульная структура (v2.0.24)
│   ├── __init__.py                       # Инициализация модуля (метаданные v2.0.24)
...
|--------|------|-------------------|
| 2.0.24 | 28.10.2025 | **Текущая версия** - Стабильная версия с полной системой тестирования |
