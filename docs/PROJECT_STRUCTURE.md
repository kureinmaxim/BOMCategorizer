...
│
├── 📦 bom_categorizer/                   # Модульная структура (v2.0.25)
│   ├── __init__.py                       # Инициализация модуля (метаданные v2.0.25)
...
├── 🔧 post_install.ps1                   # Скрипт установки (с слиянием БД)
...
|--------|------|-------------------|
| 2.0.33 | 31.10.2025 | **Текущая версия** - Парсинг многострочных элементов, PAT подборы, база данных в инсталляторе, скрипты восстановления |
