...
## 🗂️ Организация файлов (v3.3.0 / v4.2.2)

> 🎨 **НОВОЕ:** Проект поддерживает две независимые версии GUI:
> - **Standard v3.3.0** (Tkinter) - стабильная
> - **Modern Edition v4.2.2** (PySide6) - современная с горячими клавишами и Drag & Drop
> - **Экспериментальная ветка** `experimental/new-feature` с расширенными функциями
...
|--------|------|-------------------|
| **3.3.0/4.2.2** | **12.11.2025** | **🎉 ТЕКУЩАЯ ВЕРСИЯ** - Модульный рефакторинг Modern Edition! 10 модулей (~5000 строк), глобальный поиск, поиск PDF, экспериментальная ветка с Drag & Drop, CLI и PDF экспортом. Горячие клавиши портированы в Standard v3.3.0 |
...
*Версия проекта: Standard 3.3.0 / Modern Edition 4.2.2*  
