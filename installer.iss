...
Source: "*"; Excludes: ".venv\*;out\*;out_*\*;__pycache__\*;example\*;test_*.xlsx;*_from_*.xlsx;categorized*.xlsx"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "post_install.ps1"; DestDir: "{app}"; Flags: ignoreversion
Source: "run_app.bat"; DestDir: "{app}"; Flags: ignoreversion
Source: "interactive_classify.py"; DestDir: "{app}"; Flags: ignoreversion
