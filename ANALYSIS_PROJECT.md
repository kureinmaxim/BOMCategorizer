...
> **Дата анализа / Analysis Date:** 09.11.2025  
...
| **Размер установщика** | ~25-40 MB | ~35-50 MB |
...
### v3.2.2 - Standard Edition (08.11.2025)
- ✅ Добавлена метка "Standard" в конфиг
- ✅ Обновлен заголовок окна
- ✅ Blockchain-like версионирование БД (двузначные версии)
- ✅ Динамическое управление размером окна

### v4.0.0 - Modern Edition (08.11.2025)
- ✨ **Новая GUI на PySide6** - современный дизайн
- ✨ **Приглушенная цветовая палитра** - комфортная для глаз
- ✨ **Увеличенные шрифты** (13-14pt) - лучшая читаемость
- ✨ **QSS стили** - профессиональное оформление
- ✨ **Модульные диалоги** - `dialogs_qt.py`
- ✨ Загрузка из `config_qt.json`
- ⭐ **Горячие клавиши** - Ctrl+O (открыть файлы), Ctrl+R (запустить обработку), Ctrl+Q (выход)
- 🖱️ **Drag & Drop** - перетаскивание файлов прямо в окно приложения
- 📚 **Меню "Помощь"** - контекстная помощь (F1), база знаний, информация о программе, системная информация
- 🔗 **Ссылка на GitHub** - в диалогах "О программе" и "Системная информация"
- 🔍 **Масштабирование интерфейса** - 70%, 80% (по умолчанию), 90%, 100%, 110%, 125% с сохранением настроек
- 🎛️ **Режимы работы** - простой, расширенный, эксперт для адаптации интерфейса
