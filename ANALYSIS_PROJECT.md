# Анализ кодовой базы: BOM Categorizer v3.3.0 / v4.3.0
...
> **Версии / Versions:** Standard v3.3.0 (Tkinter) + Modern Edition v4.3.0 (PySide6)  
...
| Характеристика | Standard v3.3.0 | Modern Edition v4.3.0 |
|---------------|-----------------|----------------------|
...
| **Документации** | 13 MD файлов + CHANGELOG (~5000 строк) |
...
### v4.3.0 - Modern Edition (12.11.2025) ⭐ ТЕКУЩАЯ
...
*Версия проекта: Standard 3.3.0 / Modern Edition 4.3.0*  
