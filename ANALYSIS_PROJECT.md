# Анализ кодовой базы: BOM Categorizer v3.2.2 / v4.0.0
# Codebase Analysis: BOM Categorizer Standard & Modern Edition

> **Дата анализа / Analysis Date:** 12.11.2025  
> **Тип проекта / Project Type:** Desktop приложение (Python + Tkinter/PySide6) / Desktop Application  
> **Версии / Versions:** Standard v3.2.2 (Tkinter) + Modern Edition v4.0.0 (PySide6)  
> **Экспериментальная ветка:** experimental/new-feature (Drag & Drop, CLI, PDF Export)  
...
| Характеристика | Standard v3.3.0 | Modern Edition v4.2.2 |
|---------------|-----------------|----------------------|
...
| **Размер установщика** | ~25-40 MB | ~35-50 MB (+reportlab для PDF) |
| **Модульная структура** | Базовая | Расширенная (10 модулей) |
| **Экспериментальные функции** | Нет | Да (D&D, CLI, PDF в ветке) |
...
| Метрика | Значение |
|---------|----------|
| **Строк кода** | ~5,000+ (Python) |
| **Модулей** | 10 (bom_categorizer/*) + manage_database.py |
| **Функций** | 80+ |
...
| **Документации** | 12 MD файлов + CHANGELOG (~4300 строк) |
| **Тестов** | 4 файла (unit + integration) |
| **Версия Standard** | 3.3.0 |
| **Версия Modern** | 4.2.2 |
| **Эксп. ветка** | experimental/new-feature |
...
### v4.2.2 - Modern Edition (12.11.2025) ⭐ ТЕКУЩАЯ
...
- 📄 **Экспорт в PDF** - `pdf_exporter.py` (~380 строк)
  ...
  - Титульная страница
  - Автоэкспорт (опция)
- 📖 **Документация** - `EXPERIMENTAL_FEATURES.md` (319 строк), `DRAG_DROP_README.md` (181 строка)
