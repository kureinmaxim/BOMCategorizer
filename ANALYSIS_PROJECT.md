# Анализ кодовой базы: BOM Categorizer v3.3.0 / v4.4.1
# Codebase Analysis: BOM Categorizer Standard & Modern Edition

> **Дата анализа / Analysis Date:** 16.11.2025  
> **Тип проекта / Project Type:** Desktop приложение (Python + Tkinter/PySide6) / Desktop Application  
> **Версии / Versions:** Standard v3.3.0 (Tkinter) + Modern Edition v4.4.1 (PySide6)  
...
| Характеристика | Standard v3.3.0 | Modern Edition v4.4.1 |
|---------------|-----------------|----------------------|
...
├── ⚙️ config_qt.json                # ✨ Конфигурация Modern Edition v4.4.1
...
class BOMCategorizerMainWindow(QMainWindow):
    def __init__(self):
        # Загружаем config_qt.json (v4.4.1)
...
### v4.4.1 - Modern Edition (16.11.2025) ⭐ ТЕКУЩАЯ
...
*Версия проекта: Standard 3.3.0 / Modern Edition 4.4.1*  
*Новое: 🍎 macOS Retina support (v4.3.6), 🔄 LibreOffice integration (v4.3.7), 📁 Config Path Fix (v4.4.1)*  
